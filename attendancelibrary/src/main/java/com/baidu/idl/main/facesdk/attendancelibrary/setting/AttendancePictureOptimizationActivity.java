...
public class AttendancePictureOptimizationActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendance_picture_optimization);
        init();
        initListener();
    }
    private void init(){
    ...
    private void initListener(){
        tipsdarkEnhance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(groupFundarkEnhance, tvdarkEnhance,
                        AttendancePictureOptimizationActivity.this,
        ...
        tipsBestImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(groupBestImage, tvBestImage,
                        AttendancePictureOptimizationActivity.this,
