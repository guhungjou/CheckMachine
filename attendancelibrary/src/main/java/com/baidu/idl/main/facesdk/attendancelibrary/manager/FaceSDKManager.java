...
import com.baidu.idl.main.facesdk.attendancelibrary.model.GlobalSet;
...
import com.example0.datalibrary.db.DBManager;
...
import static com.baidu.idl.main.facesdk.attendancelibrary.model.GlobalSet.FEATURE_SIZE;
        ...
        if (featureType == 3) {
            ...
            if (illumScore > SingleBaseConfig.getBaseConfig().getIllumination()) {
                if (faceInfos != null && nirInstance != null) {
                    ...
                    Log.e("FS","featureSize = " + featureSize);
...
//        }
//        Log.e("uninitModel","attendancelibrary-uninitModel"
//                + faceDetect.uninitModel()
//                + faceFeature.uninitModel()
//                + faceDetectNir.uninitModel()
//                + faceLiveness.uninitModel());
