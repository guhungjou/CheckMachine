...
public class FaceLivinessTypeActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendance_facelivinesstype);
        init();
    }
    ...
    public void init() {
        ...
        flsRgbLive.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b) {
                    // 镜头类型
                    int cameraTypeRD = SingleBaseConfig.getBaseConfig().getCameraType();
                    int cameraTypeRND = SingleBaseConfig.getBaseConfig().getCameraType();
                    flsRgbLive.setChecked(true);
...
//        }
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.fls_save) {
            ...
            startActivity(new Intent(FaceLivinessTypeActivity.this, AttendanceLensSelectionActivity.class));
