...
//import com.example0.callback.CameraDataCallback;
//import com.example0.model.SingleBaseConfig;
    ...
    public void stopPreview() {
        if (mCamera != null) {
            try {
                ...
                mCamera.release();
                mCamera = null;
//                boolean cameraInUse = isCameraInUse(1);
//                Log.e(TAG, "cameraInUse:" + cameraInUse);
                if (mCameraDataCallback != null) {
                    Log.e(TAG, "关闭预览模式");
                    mCameraDataCallback.onStopPreview();
                }
            } catch (Exception e) {
